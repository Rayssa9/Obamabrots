...
if(isset($_SESSION['deslocado'])){

    if($_SESSION['deslocado']==0){
...
Moral da história? - Não tem moral nenhuma! Foi de sacanagem mesmo... E vê se atende o telefone educadamente, pois posso ser eu ligando para você por engano... </h1>
<h1>Ae pessoal, recebi isso aqui por e-mail a um tempo atrás, então já vou adiantando que é coisa velha e o texto é gigante, se não quiser não leia e espere um resumo ou comentários do pessoal. Não tem muita graça mas to postando pois alguém pode gostar e como o boteco tá meio parado mesmo, aqui vai o texto:
